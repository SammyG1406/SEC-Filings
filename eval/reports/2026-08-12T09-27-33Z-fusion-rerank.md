# Retrieval evaluation report — RAG Fusion + rerank — 2026-08-12T09-27-33Z
...
|---|---|---|---|---|
| Recall@k | 0.650 | 0.825 | 0.825 | 0.875 |
| Precision@k | 0.650 | 0.275 | 0.165 | 0.087 |
| MRR@k | 0.650 | 0.729 | 0.729 | 0.736 |
| NDCG@k | 0.650 | 0.754 | 0.754 | 0.771 |

## computed_comparative (n=15)

| Metric | k=1 | k=3 | k=5 | k=10 |
|---|---|---|---|---|
| Recall@k | 0.467 | 0.800 | 0.800 | 0.933 |
| Precision@k | 0.467 | 0.267 | 0.160 | 0.093 |
| MRR@k | 0.467 | 0.611 | 0.611 | 0.631 |
| NDCG@k | 0.467 | 0.660 | 0.660 | 0.704 |
