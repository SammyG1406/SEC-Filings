# Retrieval evaluation report — RAG Fusion + routing + rerank — 2026-08-12T12-29-48Z
...
|---|---|---|---|---|
| Recall@k | 0.625 | 0.825 | 0.850 | 0.875 |
| Precision@k | 0.625 | 0.275 | 0.170 | 0.087 |
| MRR@k | 0.625 | 0.721 | 0.727 | 0.731 |
| NDCG@k | 0.625 | 0.748 | 0.759 | 0.768 |

## computed_comparative (n=15)

| Metric | k=1 | k=3 | k=5 | k=10 |
|---|---|---|---|---|
| Recall@k | 0.400 | 0.800 | 0.867 | 0.933 |
| Precision@k | 0.400 | 0.267 | 0.173 | 0.093 |
| MRR@k | 0.400 | 0.589 | 0.606 | 0.617 |
| NDCG@k | 0.400 | 0.644 | 0.672 | 0.696 |
